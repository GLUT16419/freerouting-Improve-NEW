...
public class RouterCounters implements Serializable {
  ...
  // Optional: elapsed time in milliseconds for the current stage (fanout/autoroute/optimization).
  @SerializedName("stage_elapsed_millis")
  public Long stageElapsedMillis;
}