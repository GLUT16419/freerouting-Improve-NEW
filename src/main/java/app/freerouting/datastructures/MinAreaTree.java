...
public class MinAreaTree extends ShapeTree {
  ...
  public Set<Leaf> overlaps(RegularTileShape p_shape) {
    ...
    for (; ; ) {
      ...
      if (curr_node.bounding_shape == null || curr_node.bounding_shape.intersects(p_shape)) {
  ...
  public void remove_leaf(Leaf p_leaf) {
    ...
    if (other_leaf == null) {
      FRLogger.warn("MinAreaTree.remove_leaf: other_leaf is null, attempting recovery");
      root = parent.first_child != null ? parent.first_child : parent.second_child;
